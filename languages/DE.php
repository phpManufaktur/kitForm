...
$LANG = array(
        ...
        '<p>Then newsletter abonnement for the email address <b>{{ email }}</b> was updated.</p>'  
        ...
        'The file size exceeds the php.ini directive "upload_max_size" <b>{{ size }}</b>.'    
            => 'Die hochgeladene Datei überschreitet die in der Anweisung upload_max_filesize in php.ini festgelegte Größe von {{ size }}',
        ...
        'The file <b>{{ file }}</b> was uploaded partial'    
            => 'Die Datei <b>{{ file }}</b> wurde nur teilweise hochgeladen.',
        'Unspecified error, no description available'
            => 'Während der Datenübertragung ist ein nicht näher beschriebener Fehler aufgetreteten.',
        ...
        '[kitForm] The contact has <a href="{{ url }}">submitted a form</a>'
            => '[kitForm] Der Kontakt hat ein <a href="%s">Formular übermittelt</a>.',
        '[kitForm] The contact has <a href="{{ url }}">submitted a feedback</a>.'
            => '[kitForm] Der Kontakt hat ein <a href="%s">Feedback übermittelt</a>.',
